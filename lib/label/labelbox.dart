...
class LabelBox extends StatefulWidget {
  ...
  LabelBox(this.results, this.previewH, this.previewW, this.screenH, this.screenW,
      this.model);

  @override
  _LabelBox createState() => new _LabelBox();
}

class _LabelBox extends State<LabelBox> {
  ...
  late final String speak;
  late final String prevString;
